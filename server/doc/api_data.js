define({ "api": [
  ...
  },
  {
    ...
    "type": "socket",
    "url": "Emits",
    "title": "value signal to all parents AND the specified url",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "version": "0.0.0",
    "filename": "server/socketHandlers/delete.js",
    "groupTitle": "delete"
  },
  {
  ...
  },
  {
    ...
    "type": "socket",
    "url": "update",
    "title": "Updates the javascript object at the specified url and may involve update, insert of remove tasks on exisiting objects",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "type": "<p>Object</p> ",
            "optional": false,
            "field": "updateRequest.data",
            "description": "<p>A javascript object that has updates that are to be applied at the specified path</p> "
          }
        ]
      }
    },
    "version": "0.0.0",
    "filename": "server/socketHandlers/update.js",
    "groupTitle": "update"
  }
] });
